  ...
  (this.PIXI.sound = (function (t, e, n, o) {
            ...
            set: function (t) {
              ...
              if (
                ...
                t.forEach(function (t) {
                  null === n
                    ? e._input.connect(t.destination)
    ...
    var h = (function () {
        ...
        return (
          ...
          (n.prototype.refresh = function () {
            if (this._source) {
              ...
              h.setParamValue(this._gain.gain, i * o * n),
                h.setParamValue(
          ...
          Object.defineProperty(n.prototype, "_enabled", {
            set: function (t) {
              e.Ticker.shared.remove(this._updateListener, this),
                t && e.Ticker.shared.add(this._updateListener, this);
            },
            enumerable: !0,
            configurable: !0,
          }),
      ...
      d = (function (t) {
        ...
        return (
          ...
          Object.defineProperty(e.prototype, "script", {
            get: function () {
              return (
                this._script ||
                  ((this._script =
                    this.context.audioContext.createScriptProcessor(
                      e.BUFFER_SIZE
                    )),
          ...
          (e.prototype.cloneBufferSource = function () {
            ...
            (e.buffer = t.buffer),
              h.setParamValue(e.playbackRate, t.playbackRate.value),
              (e.loop = t.loop);
            var n = this.context.audioContext.createGain();
            return (
              e.connect(n), n.connect(this.destination), { source: e, gain: n }
            );
          }),
      ...
      _ = (function () {
        ...
        return (
          (t.prototype.init = function (t) {
            (this.parent = t),
              (this._nodes = new d(this.context)),
      ...
      y = (function (t) {
        function e() {
          ...
          return (
            ...
            (o._offlineCtx = new e.OfflineAudioContext(
              1,
              2,
      ...
      g = {
          ...
          function e(n, o, i, r, s, u, a, c, l, f) {
            ...
            if (!p().useLegacy) {
              var _ = [
                ...
                { f: e.F250, type: "peaking", gain: r },
                { f: e.F500, type: "peaking", gain: s },
                { f: e.F1K, type: "peaking", gain: u },
                { f: e.F2K, type: "peaking", gain: a },
                { f: e.F4K, type: "peaking", gain: c },
                ...
                return (
                  (e.type = t.type),
                  h.setParamValue(e.Q, 1),
                  (e.frequency.value = t.f),
                  h.setParamValue(e.gain, t.gain),
                  e
                );
              });
              ((d = t.call(this, _[0], _[_.length - 1]) || this).bands = _),
                (d.bandsMap = {});
              for (var y = 0; y < d.bands.length; y++) {
                var m = d.bands[y];
                y > 0 && d.bands[y - 1].connect(m),
                  (d.bandsMap[m.frequency.value] = m);
              }
              return d;
            }
        ...
        DistortionFilter: (function (t) {
          function e(e) {
            ...
            if (!p().useLegacy) {
              ...
              return (
                ((n = t.call(this, o) || this)._distortion = o),
                (n.amount = e),
                n
              );
            }
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "amount", {
              ...
              set: function (t) {
                ...
                for (
                  var e, n = new Float32Array(44100), o = Math.PI / 180, i = 0;
                  i < 44100;
                  ++i
                )
                  (e = (2 * i) / 44100 - 1),
                    (n[i] =
                      ((3 + t) * e * 20 * o) / (Math.PI + t * Math.abs(e)));
            ...
            if (!p().useLegacy) {
              ...
              return (
                s.createStereoPanner
                  ...
                  : (((i = s.createPanner()).panningModel = "equalpower"),
                    (r = i)),
                ((n = t.call(this, r) || this)._stereo = o),
                (n._panner = i),
                (n.pan = e),
                n
              );
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "pan", {
              ...
              set: function (t) {
                (this._pan = t),
                  this._stereo
                    ? h.setParamValue(this._stereo.pan, t)
        ...
        ReverbFilter: (function (t) {
          function e(e, n, o) {
            ...
            if (!p().useLegacy)
              return (
                ((i = t.call(this, null) || this)._seconds = i._clamp(
                  e,
                  1,
                  50
                )),
          ...
          return (
            ...
            (e.prototype._rebuild = function () {
              for (
                var t,
                  e = p().context.audioContext,
                  n = e.sampleRate,
                  o = n * this._seconds,
                  i = e.createBuffer(2, o, n),
                  r = i.getChannelData(0),
                  s = i.getChannelData(1),
                  u = 0;
                u < o;
                u++
              )
                (t = this._reverse ? o - u : u),
                  (r[u] =
                    (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay)),
                  (s[u] =
                    (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay));
        ...
        MonoFilter: (function (t) {
          function e() {
            ...
            if (!p().useLegacy) {
              ...
              return (
                i.connect(o), ((e = t.call(this, i, o) || this)._merger = i), e
              );
            }
        ...
        TelephoneFilter: (function (t) {
          function e() {
            if (!p().useLegacy) {
              ...
              return (
                (n.type = "lowpass"),
                h.setParamValue(n.frequency, 2e3),
                (o.type = "lowpass"),
                h.setParamValue(o.frequency, 2e3),
                (i.type = "highpass"),
                h.setParamValue(i.frequency, 500),
                (r.type = "highpass"),
                h.setParamValue(r.frequency, 500),
                n.connect(o),
                o.connect(i),
                i.connect(r),
        ...
        return (
          ...
          (n.prototype.play = function (t) {
            ...
            (this._speed = s),
              ...
              (this._start = Math.max(0, this._start - n.PADDING)),
              (this._end = Math.min(this._end + n.PADDING, this._duration)),
              (this._source.onloadedmetadata = function () {
                o._source &&
                  ...
                  e.Ticker.shared.add(o._onUpdate, o));
              }),
              (this._source.onended = this._onComplete.bind(this)),
              this._source.play(),
              this.emit("start");
          ...
          (n.prototype._onComplete = function () {
            e.Ticker.shared.remove(this._onUpdate, this),
              this._internalStop(),
              this.emit("progress", 1, this._duration),
              this.emit("end", this);
          }),
            ...
            if (4 !== e.readyState) {
              ...
              var o = function () {
                ...
                s = function () {
                  o();
                  var n =
                    "Failed to load audio element (code: " + e.error.code + ")";
                  t && t(new Error(n));
                };
              e.addEventListener("canplaythrough", i, !1),
                e.addEventListener("load", i, !1),
                e.addEventListener("abort", r, !1),
      ...
      x = (function (t) {
        function e() {
          ...
          return (
            (e.speed = 1), (e.volume = 1), (e.muted = !1), (e.paused = !1), e
          );
        }
        return (
          u(e, t),
      ...
      O = { HTMLAudioMedia: P, HTMLAudioInstance: v, HTMLAudioContext: x },
      j = [
        "mp3",
        "ogg",
        "oga",
    ...
    var I = (function () {
        ...
        return (
                ...
                ? n.forEach(function (e) {
                    t.LoaderResource.setExtensionXhrType(
                      ...
                      t.LoaderResource.setExtensionLoadType(
                        e,
                        t.LoaderResource.LOAD_TYPE.AUDIO
                      );
                  })
                : n.forEach(function (e) {
                    t.LoaderResource.setExtensionXhrType(
          ...
          (e.use = function (t, e) {
            t.data && j.indexOf(t.extension) > -1
              ? (t.sound = p().add(t.name, {
                  loaded: e,
                  preload: !0,
                  url: t.url,
                  source: t.data,
        ...
        return (
          (t.from = function (e) {
            ...
            return (
              ...
              Object.freeze(n),
              new t(p().useLegacy ? new P() : new _(), n)
            );
          }),
          Object.defineProperty(t.prototype, "context", {
            get: function () {
      ...
      T = (function () {
        ...
        return (
          (t.prototype.init = function () {
            return (
              this.supported && (this._webAudioContext = new y()),
              (this._htmlAudioContext = new x()),
              (this._sounds = {}),
    ...
    var G = {
        ...
        render: function (t, e) {
          ...
          (e = c({ width: 512, height: 128, fill: "black" }, e || {})),
            (n.width = e.width),
            (n.height = e.height);
